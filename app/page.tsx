...
function AppWindow({app,title,icon,minimized,maximized,focused,zIndex,onFocus,onClose,onMinimize,onMaximize,children}:{app:WindowAppId;title:string;icon:string;minimized:boolean;maximized:boolean;focused:boolean;zIndex:number;onFocus:()=>void;onClose:()=>void;onMinimize:()=>void;onMaximize:()=>void;children:React.ReactNode}){
