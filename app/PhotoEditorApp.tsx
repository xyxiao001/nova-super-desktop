...
export default function PhotoEditorApp({active,initialImage,onSave}:{active:boolean;initialImage:PhotoSource|null;onSave:(mode:"copy"|"replace",name:string,content:string)=>void}) {
