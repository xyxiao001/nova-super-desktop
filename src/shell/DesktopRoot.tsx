...
export default function DesktopRoot() {
  ...
  },[closeWindow,contextMenu,cycleWindows,fileClipboard,fileUndo,focused,focusedApp,focusedNote,items,minimizeWindow,openNewWindow,pendingFileOperation,selectedIds,snapWindow,startOpen,systemPanelOpen,taskbarMenu,updateWindow,windowInstances]);
