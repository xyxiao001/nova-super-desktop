...
export const APP_MANIFESTS = defineAppManifests({
  ...
  frontline: { label: "王国大作战：前线", icon: "前", kind: "frontline", launcher: false, taskbarPinned: false, resourcePackages: [{ id: "frontline", label: "王国大作战：前线美术", description: "沙漠地图、英雄、怪物与战斗界面资源", displayOrder: 6, matchPriority: 5, pathPrefixes: ["/assets/games/frontline/"] }], window: { size: "canvas", minWidth: 520, minHeight: 680, mobile: "fullscreen", initial: { width: "min(720px,92vw)", height: "min(900px,90vh)", left: "19vw", top: "24px" } }, load: () => import("../../apps/frontline/entry") },
