...
export type WindowInstancePolicy = "singleton" | "multiple" | "per-resource";
...
export const APP_MANIFESTS = defineAppManifests({
  ...
  explorer: { label: "文件资源管理器", icon: "▰", kind: "explorer", launcher: true, taskbarPinned: true, startPinned: true, startGroup: "productivity", window: { size: "wide", mobile: "fullscreen", instancePolicy: "multiple", initial: { width: "min(1020px,90vw)", height: "min(680px,84vh)", left: "9vw", top: "48px" } }, load: () => import("../../apps/explorer/entry") },
  notes: { label: "记事本", icon: "▤", kind: "notes", launcher: true, taskbarPinned: true, startPinned: true, startGroup: "productivity", window: { size: "wide", mobile: "fullscreen", instancePolicy: "per-resource", initial: { width: "min(880px,86vw)", height: "min(620px,82vh)", left: "12vw", top: "54px" } }, load: () => import("../../apps/notes/entry") },
  viewer: { label: "照片", icon: "▧", kind: "viewer", launcher: true, taskbarPinned: true, startPinned: true, startGroup: "create", windowIcon: "✿", resourcePackages: [{ id: "photos", label: "相册图片", description: "内置精选照片与缩略图", displayOrder: 2, matchPriority: 30, pathPrefixes: ["/photos/"], exactPaths: ["/default-photo.jpg"] }], window: { size: "wide", mobile: "fullscreen", instancePolicy: "per-resource", initial: { width: "min(980px,88vw)", height: "min(650px,84vh)", left: "8vw", top: "42px" } }, load: () => import("../../apps/viewer/entry") },
  ...
  cybercity: { label: "赛博城市", icon: "城", kind: "cybercity", launcher: true, taskbarPinned: false, startGroup: "system", resourcePackages: [{ id: "cybercity", label: "赛博城市美术", description: "城市立面、店铺与远景美术资源", displayOrder: 6, matchPriority: 5, pathPrefixes: ["/assets/apps/cybercity/"] }], window: { size: "canvas", minWidth: 600, minHeight: 500, mobile: "fullscreen", initial: { width: "min(1280px,94vw)", height: "min(860px,88vh)", left: "3vw", top: "32px" } }, load: () => import("../../apps/cybercity/entry") },
  ...
  folder: { label: "文件夹", icon: "▱", kind: "folder", launcher: false, taskbarPinned: false, window: { size: "standard", mobile: "fullscreen", instancePolicy: "per-resource", initial: { width: "min(760px,82vw)", height: "min(520px,74vh)", left: "20vw", top: "82px" } }, load: () => import("../../apps/folder/entry") },
  ...
  frontline: { label: "王国大作战：前线", icon: "前", kind: "frontline", launcher: false, taskbarPinned: false, resourcePackages: [{ id: "frontline", label: "王国大作战：前线原版资源", description: "原版 Unity 引擎、单机营地、地图与战斗资源", displayOrder: 6, matchPriority: 5, pathPrefixes: ["/assets/games/frontline/", "/games/frontline-native/"] }], window: { size: "canvas", minWidth: 520, minHeight: 680, mobile: "fullscreen", initial: { width: "min(720px,92vw)", height: "min(900px,90vh)", left: "19vw", top: "24px" } }, load: () => import("../../apps/frontline/NativeEntry") },
  fanren: { label: "凡人修仙传：星海飞驰", icon: "仙", kind: "fanren", launcher: false, taskbarPinned: false, resourcePackages: [{ id: "fanren", label: "凡人修仙传原版资源", description: "Laya 3D 引擎、修仙场景、角色与炼器资源", displayOrder: 6, matchPriority: 5, pathPrefixes: ["/games/fanren-native/"] }], window: { size: "canvas", minWidth: 360, minHeight: 600, mobile: "fullscreen", initial: { width: "min(520px,92vw)", height: "min(940px,90vh)", left: "25vw", top: "24px" } }, load: () => import("../../apps/fanren/entry") },
  doupo: { label: "斗破苍穹", icon: "斗", kind: "doupo", launcher: false, taskbarPinned: false, resourcePackages: [{ id: "doupo", label: "斗破苍穹原版资源", description: "Unity 引擎、原版斗者、战斗场景与界面资源", displayOrder: 7, matchPriority: 5, pathPrefixes: ["/games/doupo-native/"] }], window: { size: "canvas", minWidth: 360, minHeight: 600, mobile: "fullscreen", initial: { width: "min(520px,92vw)", height: "min(940px,90vh)", left: "25vw", top: "24px" } }, load: () => import("../../apps/doupo/entry") },
...
export type AppDefinition = {
  ...
  windowIcon?: string;
  taskbarIcon?: string;
  window: AppWindowConfig & { instancePolicy: WindowInstancePolicy };
};
