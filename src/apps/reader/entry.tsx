...
export default function ReaderApp() {
  const active = useWindowRuntime().isAppActive("reader");
  const { launchIntent, onLaunchHandled } = useAppLaunchIntent("reader");
  const { createReaderExcerpt: onCreateExcerpt } = useWorkspaceRuntime();
